...
# 0= PEG chain
# 1= Broken Crosslinkers in PEG chain
# 2= 1,2 regiochemistry
# 3= 1,3 regiochemistry
...
##      print('num_broken_cumulative',num_broken_cumulative)
      ...
      [t, n_bonds_init, n_bonds_final,M,chain_array, crosslinker_array, num_broken, num_broken_cumulative_new,num_considered_cumulative, sum_ni,[norm_rates_0,norm_rates_1,norm_rates_2,norm_rates_3]] = mymin.KMCbondbreak([p.U0,p.U11,p.U12,p.U_broken],[p.tau0,p.tau1,p.tau_broken],[p.delta0,p.delta11,p.delta12,p.delta_broken], p.del_t, 0, i+1,M,chain_array, crosslinker_array,num_broken_cumulative,num_considered_cumulative)
##      print('num_broken_cumulative',num_broken_cumulative)
...
####np.savetxt('n_i_all_chains.txt',np.array(n_i_arr)) 
